...
/**
 * Android KeyStore-backed Hardware Security Module helper for Kinetix Controller.
 * Ensures private keys are never stored in plaintext and never leave secure hardware.
 */
object CryptoManager {
    private const val ANDROID_KEYSTORE = "AndroidKeyStore"
    private const val KEY_ALIAS = "kinetix_device_identity_key"
    private const val PREFS_NAME = "kinetix_device_prefs"
    ...
    /**
     * Get or generate a persistent friendly controller identifier in format KX-XXXX-XXXX
     */
